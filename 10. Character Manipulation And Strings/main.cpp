...
int main(){
    ...
    //* std::isalum :check if charater is alphnumeric. Return= Non-zero(usually a 1 but can give other values) value if true, 0 otherwise.
     /*
    std::cout << std::endl;
   ...
   //* std::isalpha : check if charater is alphabetic
   ...
   //* std::isblank : Check if a character is blank
    /*
    std::cout << std::endl;
   ...
   */
	...
	//* std::islower / std::isupper : Check if character is lowercase or uppercase
    /*
    ...
    */
    ...
    //* std::isdigit : Check if a character is a digit
    /*
    std::cout << std::endl;
    ...
    */
    ...
    /*
	//* std::strlen : Find the length of a string, real arrays and those decayed into pointers
	...
	//* strlen ignores null character(spaces)
	...
	//* Prints size of pointer // 8 because all pointers are 8bytes
    std::cout << "sizeof(message2) : " << sizeof(message2) << std::endl;
    */


   //* std::strcmp - signature : int strcmp( const char *lhs, const char *rhs ); // Returns negative value if lhs appears before rhs in lexicographical order, //Zero if lhs and rhs compare equal. //and Positive value if lhs appears after rhs in lexicographical order. 
    /*
    std::cout << std::endl;
    ...
    */
	...
	//* std::strncmp : int strncmp( const char *lhs, const char *rhs, std::size_t count ); //Compares n characters in the strings //Returns : Negative value if lhs appears before rhs in lexicographical order. //Zero if lhs and rhs compare equal, or if count is zero.  //Positive value if lhs appears after rhs in lexicographical order. 
    /*
    //Print out the comparison
    ...
    */
    ...
    //* A lesser version that will loop 25 times // not good code, won't work
    /*
	//Find the first occurrence of a character 
	//CODE STOLEN FROM THE DOCS : 
	std::cout << std::endl;
    ...
    */
    ...
    //* the appended variable can't be a const because it has to be modifiable. (std::strcat(x, y), x's value will change to x=x+y)
    */
	...
	//NOTE TO SELF : 
	//* Describe what's going to happen in std::strcat before you do the cat //source is going to be appended to dest, //? will start by overriding the null character in dest
    ...
    */
    ...
    // +1 because std::strlen does NOT account for the null character
    ...
    */
    ...
    //? in this case, the planet1 pointer does change the array to the new string but the original string still stays in memory (WASTED out). std::string changes the array but deletes the old array so there's no memory loss
