...
int main(){
    ...
    std::cout << "The value1 is (after +=5) : " << value1 << std::endl; // 50

    std::cout << std::endl;
    value1 -=5; // equivalent to value1 = value1 - 5
    std::cout << "The value1 is (after -=5) : " << value1 << std::endl; // 45 

    std::cout << std::endl;
    value1 *=2;
    std::cout << "The value1 is (after *=2) : " << value1 << std::endl; // 90

    std::cout << std::endl;
    value1 /= 3;
    std::cout << "The value1 is (after /=3) : " << value1 << std::endl; // 30

    std::cout << std::endl;
    value1 %= 11;
    std::cout << "The value1 is (after %=11) : " << value1 << std::endl;// 8
    ...
    std::cout << "numberA < numberB : " << (numberA < numberB) << std::endl;
	std::cout << "numberA <= numberB : " << (numberA <= numberB) << std::endl;
    std::cout << "numberA > numberB : " << (numberA > numberB) << std::endl;
    std::cout << "numberA >= numberB : " << (numberA >= numberB) << std::endl;
    std::cout << "numberA == numberB : " << (numberA == numberB) << std::endl;
	...
	bool result1 = (numberA == numberB);
    
    std::cout <<  numberA << " == " << numberB << " : " << result1 <<  std::endl;
    ...
    std::cout << " a1 && b1 : " << (a1 && b1) << std::endl; // false
    std::cout << " a1 && c1 : " << (a1 && c1 ) << std::endl; // true
    std::cout << " a1 && b1 && c1 :" << (a1 && b1 && c1) << std::endl; // false
	...
	// !(a &&b) || c
	std::cout << "!(a &&b) || c : " << (!(a1 &&b1) || c1) << std::endl; // true
	...
	std::cout << "(d > e) && (d > f) : " << ((d1 > e1) && (d1 > f1)) << std::endl; // true
	std::cout << "(d==e) || (e <= f ) : " << ((d1==e1) || (e1 <= f1 ) ) << std::endl;
	std::cout << "(d < e) || (d > f) : " << ((d1 < e1) || (d1 > f1)) << std::endl;
	std::cout << "(f > e) || (d < f) : " << ((f1 > e1) || (d1 < f1)) << std::endl;
	std::cout << "(d > f) && (f <= d) : " << ((d1 > f1) && (f1 <= d1)) << std::endl;
	std::cout << "(d > e) && (d <= f) : " << ((d1 > e1) && (d1 <= f1)) << std::endl;
	std::cout << "(! a) && (d == e) : " << ((! a1) && (d1 == e1)) << std::endl;
	std::cout << "(! a) && (d == e) : " << ((! a1) && (d1 == e1)) << std::endl;
