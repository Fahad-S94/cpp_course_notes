...
int main(){
    ...
    int scores [10]; //* Junk data, didn't initialize
    ...
    */
    ...
    //* Read only arrays, no modifications
    /*
    ...
    */
    ...
    /*
    // int count1 { std::size(scores1)}; // std::size(introduced in C++17)
    ...
    */
    ...
    //* String literal
    /*
    char message4 [] {"Hello"}; //" " are the focus here
    ...
    */
	...
	numbers[129] = 1000; // will likely cash
